        ...
        <div className="flex flex-col xl:flex-row items-center justify-between xl:pt-8 xl:pb-14">
          ...
          <div className="text-center xl:text-left order-2 xl:order-none">
            ...
            <h1 className="h1 mb-6">
              Hello I&apos;m <br />{" "}
              <span className="text-accent">Cristian Alas</span>
            </h1>
            <p className="max-w-[500px] mb-9 text-white/80">
              I specialize in crafting elegant digital experiences 
              and have strong proficiency in various programming 
